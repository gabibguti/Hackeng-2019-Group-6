...
const bingHost = "http://dev.virtualearth.net/REST/v1/Routes";
const bingKeyQS = "key=AqYQGzgdIyqDV1DPTpT-A2LJ06AGkssTX66Xds6GCJhCINfliMXl7On_NwzfJSB5";
...
return{
	...
	change_truck_position: function(req, res){
		console.log("changing holder of tuna catch: ");

		var key = req.params.id
		var holder = req.query.position;
